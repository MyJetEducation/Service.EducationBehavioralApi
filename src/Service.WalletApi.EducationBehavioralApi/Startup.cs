...
using Service.WalletApi.EducationBehavioralApi.Modules;

namespace Service.WalletApi.EducationBehavioralApi
{
    public class Startup
    {
        ...
        {
            StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "education/behavioral");
